                ...
                <div class="container">
                    ...
                    <div class="slide-caption">
                        ...
                        <div class="slide-summary">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus, illum
                                laborum odit est quibusdam, molestias quaerat qui, eveniet voluptate debitis,
                                earum dolorem. Fuga maxime fugit excepturi, saepe fugiat quisquam quia!</p>
                        </div>
            ...
            <li>
                <div class="container">
                    ...
                    <div class="slide-caption">
                        ...
                        <div class="slide-summary">
                            <p>Perspiciatis quo, aspernatur similique? Cumque quidem ipsa et. Nobis officia
                                error nam veritatis culpa ut ullam maxime in ad hic, earum repudiandae?</p>
                        </div>
                        <a href="" class="button">Read More</a>
                    </div>
                </div>
            ...
            <li>
                <div class="container">
                    ...
                    <div class="slide-caption">
                        ...
                        <div class="slide-summary">
                            <p>Sapiente porro, laudantium consectetur doloremque. Explicabo, esse, expedita.
                                Animi dolorum aliquid nihil necessitatibus itaque quis architecto, fuga rerum.
                            </p>
                        </div>
                        <a href="" class="button">Read More</a>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 wow fadeInUp">
                    ...
                    <p class="leading">Pallentesque nibh pharetra urna elementum viverra elit duis faucibus
                        augue tempor eleifend</p>
                    <p>Tiramisu cotton candy caramels cake biscuit jelly-o chupa chups chocolate. Tootsie roll
                        lollipop topping. Macaroon ice cream cookie powder dessert gingerbread oat cake. Pudding
                        cake powder icing tart sugar plum sesame snaps.</p>
                    <p>Fruitcake tootsie roll candy. Sweet roll toffee donut. Chocolate cake gummi bears
                        fruitcake cookie biscuit cotton candy marshmallow.</p>
                    <p>Liquorice macaroon marshmallow macaroon cheesecake sweet soufflé. Cheesecake cookie
                        dessert jelly-o. Fruitcake tart topping.</p>
                ...
                <div class="col-md-6">
                    ...
                    <ul class="feature-list">
                        <li class="wow fadeInRight">
                            ...
                            <p>Candy powder. Carrot cake ice cream toffee bonbon. Donut marzipan chupa chups
                                cookie tart dessert fruitcake brownie. </p>
                        </li>
                        <li class="wow fadeInRight">
                            <i class="icon-server-lock"></i>
                            <h3>Aliquam nibh quam iaculis tempis</h3>
